...
use Riki137\AmpClient\Chunk\InformationalChunk;
use Riki137\AmpClient\HttpClientTrait;
use Riki137\AmpClient\Internal\AmpBodyV5;
...
final class AmpResponseV5 implements ResponseInterface, StreamableInterface
{
    ...
    {
        try {
            EventLoop::defer(fn() => $this->doDestruct());
        } finally {
